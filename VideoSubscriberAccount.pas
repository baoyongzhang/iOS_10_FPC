...
unit VideoSubscriberAccount;
interface

{$linkframework VideoSubscriberAccount}

uses
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesVideoSubscriberAccount, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesVideoSubscriberAccount, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include videosubscriberaccount/UndefinedTypes.inc}

{$define TYPES}
{$include videosubscriberaccount/Sources.inc}
{$undef TYPES}
...
{$include videosubscriberaccount/InlineFunctions.inc}
