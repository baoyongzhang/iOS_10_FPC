...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesCloudKit, Contacts, CoreLocation, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesCloudKit, Contacts, CoreLocation, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
