...
{$linkframework Intents}

uses
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesIntents, CoreLocation, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesIntents, CoreLocation, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include intents/UndefinedTypes.inc}

{$define TYPES}
{$include intents/Sources.inc}
{$undef TYPES}
...
{$include intents/InlineFunctions.inc}
