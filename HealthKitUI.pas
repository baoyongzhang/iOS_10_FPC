...
{$linkframework HealthKitUI}

uses
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesHealthKitUI, HealthKit, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesHealthKitUI, HealthKit, UIKit, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include healthkitui/UndefinedTypes.inc}

{$define TYPES}
{$include healthkitui/Sources.inc}
{$undef TYPES}
...
{$include healthkitui/InlineFunctions.inc}
