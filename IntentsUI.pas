...
{$linkframework IntentsUI}

uses
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesIntentsUI, Intents, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesIntentsUI, Foundation, CoreGraphics, Intents, UIKit, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include intentsui/UndefinedTypes.inc}

{$define TYPES}
{$include intentsui/Sources.inc}
{$undef TYPES}
...
{$include intentsui/InlineFunctions.inc}
