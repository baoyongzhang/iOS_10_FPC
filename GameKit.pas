...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesGameKit, ReplayKit, ModelIO, GameController, GameplayKit, SceneKit, SpriteKit, MetalKit, Metal, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesGameKit, Foundation, ReplayKit, ModelIO, GameController, GameplayKit, SceneKit, SpriteKit, MetalKit, Metal, UIKit, CTypes, MacTypes, MacOSXPosix;
{$endif}
