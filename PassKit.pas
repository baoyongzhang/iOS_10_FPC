...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesPassKit, AddressBook, Contacts, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesPassKit, UIKit, AddressBook, Contacts, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
