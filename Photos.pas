...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesPhotos, AVFoundation, CoreMedia, CoreLocation, ImageIO, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesPhotos, AVFoundation, CoreMedia, CoreImage, CoreLocation, ImageIO, UIKit, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
