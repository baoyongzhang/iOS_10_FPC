...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesMetalKit, ModelIO, Metal, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesMetalKit, ModelIO, CoreGraphics, Foundation, Metal, QuartzCore, UIKit, CTypes, MacTypes, MacOSXPosix;
{$endif}
