...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesSceneKit, Metal, GLKit, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesSceneKit, UIKit, Metal, GLKit, QuartzCore, CoreGraphics, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
