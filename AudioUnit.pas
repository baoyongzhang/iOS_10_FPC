...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesCoreMIDI, DefinedClassesAudioUnit, CoreMIDI, AudioToolbox, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesCoreMIDI, DefinedClassesAudioUnit, CoreMIDI, AudioToolbox, CTypes, MacTypes, MacOSXPosix;
{$endif}
