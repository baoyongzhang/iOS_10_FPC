...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesCoreImage, DefinedClassesFoundation, DefinedClassesQuartzCore, Metal, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesCoreImage, DefinedClassesFoundation, DefinedClassesQuartzCore, CoreImage, Foundation, Metal, OpenGLES, CoreGraphics, CoreFoundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
