...
{$linkframework Speech}

uses
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesSpeech, AVFoundation, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesSpeech, AVFoundation, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include speech/UndefinedTypes.inc}

{$define TYPES}
{$include speech/Sources.inc}
{$undef TYPES}
...
{$include speech/InlineFunctions.inc}
