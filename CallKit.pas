...
{$linkframework CallKit}

uses
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesCallKit, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesCallKit, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include callkit/UndefinedTypes.inc}

{$define TYPES}
{$include callkit/Sources.inc}
{$undef TYPES}
...
{$include callkit/InlineFunctions.inc}
