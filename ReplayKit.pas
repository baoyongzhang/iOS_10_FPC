...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesReplayKit, AVFoundation, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesReplayKit, AVFoundation, Foundation, UIKit, CTypes, MacTypes, MacOSXPosix;
{$endif}
