...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesWatchKit, HomeKit, SceneKit, MapKit, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesWatchKit, HomeKit, SceneKit, MapKit, UIKit, CoreGraphics, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
