...
{$linkframework CoreSpotlight}

uses
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesCoreSpotlight, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesCoreSpotlight, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include corespotlight/UndefinedTypes.inc}

{$define TYPES}
{$include corespotlight/Sources.inc}
{$undef TYPES}
...
{$include corespotlight/InlineFunctions.inc}
