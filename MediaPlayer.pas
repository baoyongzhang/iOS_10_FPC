...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesMediaPlayer, AVFoundation, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesMediaPlayer, AVFoundation, UIKit, CoreGraphics, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
