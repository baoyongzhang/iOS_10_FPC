...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesAudioToolbox, CoreMIDI, CoreAudio, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesAudioToolbox, CoreMIDI, Foundation, CoreFoundation, CoreAudio, CTypes, MacTypes, MacOSXPosix;
{$endif}
