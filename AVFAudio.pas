...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesAVFAudio, CoreMIDI, AudioUnit, AudioToolbox, CoreMedia, CoreAudio, AVFoundation, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesAVFAudio, CoreMIDI, AudioUnit, AudioToolbox, CoreMedia, CoreAudio, AVFoundation, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
