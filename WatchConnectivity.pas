...
unit WatchConnectivity;
interface

{$linkframework WatchConnectivity}

uses
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesWatchConnectivity, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesWatchConnectivity, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include watchconnectivity/UndefinedTypes.inc}

{$define TYPES}
{$include watchconnectivity/Sources.inc}
{$undef TYPES}
...
{$include watchconnectivity/InlineFunctions.inc}
