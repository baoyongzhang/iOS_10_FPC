...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesGLKit, ModelIO, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesGLKit, CoreGraphics, CoreFoundation, OpenGLES, ModelIO, UIKit, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
