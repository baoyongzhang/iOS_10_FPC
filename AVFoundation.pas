...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesAVFoundation, MediaToolbox, CoreVideo, CoreMedia, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesAVFoundation, QuartzCore, MediaToolbox, CoreVideo, CoreMedia, CoreGraphics, CoreFoundation, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
